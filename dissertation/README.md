...
To compile the unbtex-example.tex file, you should use latexmk.
...
Here is a history of changes:
  ...
  1.5.6 (2025-08-28):
    ...
    . In order to optimize compilation time on Overleaf, a latexmkrc
      ...
      pdflatex runs
  1.5.7 (2025-09-05):
    . The warning triggered by the use of the \showhyphens command by the
      microtype package in TeX Live 2025 has been suppressed
