...
%
\Cref{fig:fopt-real} shows where each ground-truth sits on the FOPT CDF of the ensemble:
nearly squarely at the 50th percentile.

\begin{figure}
    \centering
    \caption{
        Distribution of field oil production totals of the real field ensemble
        with ground-truth highlighted.
    }
    \label{fig:fopt-real} 
