...
\cmidrule(lr){3-8}
& &
\multicolumn{2}{c}{\bfseries Graduated} & \multicolumn{2}{C{2.7cm}}{\bfseries Academically Excluded} & 
...
\begin{tabular}{@{}lllllllllllL{1.6cm}L{1.6cm}@{}} % @{} elimina o espaço nas bordas laterais
\toprule
