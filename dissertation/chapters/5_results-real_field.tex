...
For this case study analysis, only the real field was picked as groundtruth 
for running the evaluation of DSI-ESMDA and Gated DSI-ESMDA.
%
\Cref{fig:fopt-real} shows where each groundtruth sits on the FOPT CDF of the ensemble:
