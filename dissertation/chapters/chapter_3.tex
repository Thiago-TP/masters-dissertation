...
\begin{tabular}{p{2.5cm}p{5.4cm}p{2.4cm}p{2.5cm}}
...
\label{tab:fluxo}
{\renewcommand{\arraystretch}{1.3} % espaçamento entre as linhas da tabela
\begin{tabular}{|l|m{4.3cm}|C{.7cm}|C{.7cm}|C{.7cm}|C{.75cm}|C{.7cm}|l|}
\hline%
...
\lstinputlisting[numbers=none,caption={\texttt{blockdiagram.tex}},label={cod:tex}]{codes/blockdiagram.tex}
