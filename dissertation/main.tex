...
\begin{Resumo}
    {\color{darkred}
        ...
        \begin{itemize}
            \item Qual é a motivação para escrever a dissertação?
            \item Quais são as abordagens atuais e lacunas na literatura?
            \item Quais são as suas perguntas de pesquisa e objetivos?
            \item Qual metodologia você utilizou?
            \item Quais são os principais resultados?
            \item Quais são as principais conclusões e implicações?
        \end{itemize}
    }
\end{Resumo}
% ---
