...
% Título
% ---
\titulo{Adaptive Model Aggregation Applied\\ to Reservoir Optimization} % No idioma principal do texto
...
% ---
\pchavei{aprendizado de máquina}
\kwordi{machine learning}

\pchaveii{controle de reservatório}
\kwordii{reservoir control}

\pchaveiii{otimização}
\kwordiii{optimization}

\pchaveiv{predição de produção} % Deixe vazio se não tiver
\kwordiv{production forecasting} % Deixe vazio se não tiver

\pchavev{valor presente líquido} % Deixe vazio se não tiver
\kwordv{net present value} % Deixe vazio se não tiver
% ---
