...
% Título
% ---
\titulo{Thesis title} % No idioma principal do texto
...
% ---
\tituloestrangeiro{Título da dissertação} % Escreva aqui título em português se o trabalho for escrito em inglês (caso contrário, deixe vazio)
% ---
...
% ---
\autorii[]{Deus da}{Silva} % Deixe os argumentos vazios se não tiver segundo autor
% ---
...
% ---
\numerocutter{324} % Para não imprimir o código na ficha catalográfica, deixe o argumento vazio
...
% Orientadores
% ---
\orientador[Orientador]{Prof. Dr.}{Eugênio Libório Feitosa}{Fortaleza} % Para alterar o gênero, basta trocar Orientador por Orientadora
...
\publicacao{Teste} % Deixe o argumento vazio caso não haja
...
\instituicao[Universidade de Brasília]{Faculdade de Tecnologia}{Departamento de Engenharia Mecânica} % Caso queira incluir o departamento da unidade acadêmica
% ---
