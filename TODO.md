...
- [ ] decide on a pattern for headers (whether each word is capitalized or only the first one).
...
- what's left to do/change:
    - [ ] expound contextualization with:
        1. a paragraph saying models are 3d grids of physical parameters, and list the most important parameters (check Emerick's book, most likely chapter 1)
        2. a paragraph with general description of subsurface simulators, and list commonly used simulators. Also should introduce the concept of reservoir states, listing the most important ones.
        3. a literature review subsection describing and comparing, in order: KF, EKF, EnKF, ES, ES-MDA, PFA, DSI, DSI-ESMDA. The first five are "history match" methods, and the last "data-space inversion methods". Comparisons should be group-focused. Include a timeline of the cited works.
        4. a scope subsection describing the aims of Gated DSI-ESMDA and where it can be applied. 
        5. a figure comparing data-space and model-space inversion (possibly added in the literature review subsection).
- importance (out of 10): 10
- estimated time required (in hours): 6

#### 1.3 Research problem
- what's left to do/change:
    - [ ] A paragraph highlight the gap the work fills in each of the aforementioned data-space methods in the literature review subsection.
- importance (out of 10): 10
...
- what's left to do/change: 
    - [ ] A paragraph at the start of the section stating its contents: general characterization of a reservoir and of subsurface simulation.
    - [ ]  Reservoir formation subsection: a paragraph or two on how a reservoir is formed and what it can store. Important concepts like facies and faults must be introduced here  (see Emerick's book, then Emanuel's thesis).
