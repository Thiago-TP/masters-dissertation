\begin{frame}{Results}{Discussion}
    ...
    \vfill
    \begin{itemize}
        \item [$\triangleright$] Gating reduces posterior variance loss, so increase in coverages, but also MSE and mismatch, are expected as gating intensifies.
        \item [$\triangleright$] Egg standard deviations are lesser than Olympus on two accounts:
